...
class CQLExceptionNegation(CQLException):
    """CQL filter having invalid NEGATION operation"""
    pass
...
class CQLExceptionSqlite(CQLException):
    """CQL filter exception for sqlite"""
    pass
